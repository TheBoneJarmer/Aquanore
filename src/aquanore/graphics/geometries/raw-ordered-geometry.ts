import { OrderedGeometry } from "./ordered-geometry";

export class RawOrderedGeometry extends OrderedGeometry {
    constructor(vertices: number[], normals: number[], uvs: number[]) {
        super();
