...
export class Matrix4 {
    ...
    static compose(translation: Vector3, quaternion: Quaternion, scale: Vector3): Matrix4 {
        const te = [];
    ...
    static translate(m: Matrix4, x: number, y: number, z: number): Matrix4 {
    ...
    static scale(m: Matrix4, x: number, y: number, z: number): Matrix4 {
        const result = m.clone();
        result.x1 *= x;
        result.y1 *= x;
        result.z1 *= x;
    ...
    static rotate(m: Matrix4, x: number, y: number, z: number): Matrix4 {
        let result = m.clone();
    ...
    static rotateX(m: Matrix4, angle: number): Matrix4 {
    ...
    static rotateY(m: Matrix4, angle: number): Matrix4 {
        const sin = Math.sin(angle);
        const cos = Math.cos(angle);
    ...
    static rotateZ(m: Matrix4, angle: number): Matrix4 {
        const sin = Math.sin(angle);
        const cos = Math.cos(angle);
    ...
    static ortho(left: number, right: number, top: number, bottom: number, near: number, far: number, reverseDepth: boolean = false): Matrix4 {
        const te = [];
